const translations = {
  en: {
    ...
    f4Desc:
      "Use on any device - phone, tablet, or desktop. Copy and paste directly into Google.",
  ...
  bg: {
    ...
    f4Desc: "Използвай на всяко устройство — телефон, таблет или компютър.",
